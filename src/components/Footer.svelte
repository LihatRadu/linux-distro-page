<footer class="bg-gray-900">
  <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div class="text-center">
      <h2 class="text-3xl font-extrabold bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-clip-text text-transparent sm:text-5xl"
      >Customise Your Product</h2>

      <p class="mx-auto mt-4 max-w-sm text-white sm:text-lg/relaxed">
      ...
      <a
        ...
        shadow-indigo-900/40 shadow-lg"
      >
        Get Started
      </a>
    </div>
